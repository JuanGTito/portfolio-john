        ...
        <div className='grid grid-cols-1 sm:grid-cols-12'>
            ...
            >
                ...
                <div>
                  <Link
                    href="/#contact"
                    className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-green-600 via-teal-500 to-blue-500 hover:bg-slate-200 text-white"
                  >
                    Hire Me
                  </Link>
                  <Link
                    href="/CV.pdf"
                    target="_blank"
                    className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-green-600 via-teal-500 to-blue-500 hover:bg-slate-800 text-white mt-3 inline-block"
                  >
            ...
            >
                <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative shadow-lg shadow-teal-700/30">
                    <Image
